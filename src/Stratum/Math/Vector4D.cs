...
namespace Stratum
{
    public struct Vector4D
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SharpDX.Vector4D"/> struct.
        /// </summary>
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector4D.LengthSquared"/> may be preferred when only the relative length is needed
        ...
        /// <remarks>
        /// This method may be preferred to <see cref="SharpDX.Vector4D.Length"/> when only a relative length is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <summary>
        /// Returns a <see cref="SharpDX.Vector4D"/> containing the 4D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 4D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="SharpDX.Vector4D"/> containing the 4D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="SharpDX.Vector4D"/> containing the 4D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="SharpDX.Vector4D"/> containing the 4D Cartesian coordinates of vertex 3 of the triangle.</param>
        ...
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        /// <returns>A new <see cref="SharpDX.Vector4D"/> containing the 4D Cartesian coordinates of the specified point.</returns>
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector4D.DistanceSquared(ref Vector4D, ref Vector4D, out double)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector4D.DistanceSquared(Vector4D, Vector4D)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        public static void CatmullRom(ref Vector4D value1, ref Vector4D value2, ref Vector4D value3, ref Vector4D value4, double amount, out Vector4D result)
        {
            ...
            result.X = 0.5 * ((((2.0 * value2.X) + ((-value1.X + value3.X) * amount)) + (((((2.0 * value1.X) - (5.0 * value2.X)) + (4.0 * value3.X)) - value4.X) * squared)) + ((((-value1.X + (3.0 * value2.X)) - (3.0 * value3.X)) + value4.X) * cubed));
            result.Y = 0.5 * ((((2.0 * value2.Y) + ((-value1.Y + value3.Y) * amount)) + (((((2.0 * value1.Y) - (5.0 * value2.Y)) + (4.0 * value3.Y)) - value4.Y) * squared)) + ((((-value1.Y + (3.0 * value2.Y)) - (3.0 * value3.Y)) + value4.Y) * cubed));
            result.Z = 0.5 * ((((2.0 * value2.Z) + ((-value1.Z + value3.Z) * amount)) + (((((2.0 * value1.Z) - (5.0 * value2.Z)) + (4.0 * value3.Z)) - value4.Z) * squared)) + ((((-value1.Z + (3.0 * value2.Z)) - (3.0 * value3.Z)) + value4.Z) * cubed));
            result.W = 0.5 * ((((2.0 * value2.W) + ((-value1.W + value3.W) * amount)) + (((((2.0 * value1.W) - (5.0 * value2.W)) + (4.0 * value3.W)) - value4.W) * squared)) + ((((-value1.W + (3.0 * value2.W)) - (3.0 * value3.W)) + value4.W) * cubed));
        }
        ...
        /// <summary>
        /// Modulates a vector with another by performing component-wise multiplication equivalent to <see cref="Modulate(ref SharpDX.Vector4D,ref SharpDX.Vector4D,out SharpDX.Vector4D)"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="SharpDX.Vector4D"/> to <see cref="SharpDX.Vector3"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="SharpDX.Vector4D"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="SharpDX.Vector4D"/> to compare with this instance.</param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="SharpDX.Vector4D"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        public override bool Equals(object value)
        {
            ...
            if (!ReferenceEquals(value.GetType(), typeof(Vector4D)))
                return false;
