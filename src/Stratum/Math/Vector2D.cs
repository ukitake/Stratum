...
namespace Stratum
{
    ...
    public struct Vector2D : IEquatable<Vector2D>, IFormattable, IDataSerializable
    {
        /// <summary>
        /// The size of the <see cref="SharpDX.Vector2D"/> type, in bytes.
        /// </summary>
        public static readonly int SizeInBytes = Marshal.SizeOf(typeof(Vector2D));

        /// <summary>
        /// A <see cref="SharpDX.Vector2D"/> with all of its components set to zero.
        /// </summary>
        public static readonly Vector2D Zero = new Vector2D();

        /// <summary>
        /// The X unit <see cref="SharpDX.Vector2D"/> (1, 0).
        /// </summary>
        public static readonly Vector2D UnitX = new Vector2D(1.0, 0.0);

        /// <summary>
        /// The Y unit <see cref="SharpDX.Vector2D"/> (0, 1).
        /// </summary>
        public static readonly Vector2D UnitY = new Vector2D(0.0, 1.0);

        /// <summary>
        /// A <see cref="SharpDX.Vector2D"/> with all of its components set to one.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SharpDX.Vector2D"/> struct.
        /// </summary>
        ...
        public double this[int index]
        {
            ...
            set
            {
                switch (index)
                {
                    ...
                    default: throw new ArgumentOutOfRangeException("index", "Indices for Vector2D run from 0 to 1, inclusive.");
                }
            }
        }
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector2D.LengthSquared"/> may be preferred when only the relative length is needed
        ...
        /// <remarks>
        /// This method may be preferred to <see cref="SharpDX.Vector2D.Length"/> when only a relative length is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <summary>
        /// Returns a <see cref="SharpDX.Vector2D"/> containing the 2D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="SharpDX.Vector2D"/> containing the 2D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="SharpDX.Vector2D"/> containing the 2D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="SharpDX.Vector2D"/> containing the 2D Cartesian coordinates of vertex 3 of the triangle.</param>
        ...
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        /// <returns>A new <see cref="SharpDX.Vector2D"/> containing the 2D Cartesian coordinates of the specified point.</returns>
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector2D.DistanceSquared(ref Vector2D, ref Vector2D, out double)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        /// <see cref="SharpDX.Vector2D.DistanceSquared(Vector2D, Vector2D)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        /// <summary>
        /// Multiplies a vector with another by performing component-wise multiplication equivalent to <see cref="Multiply(ref SharpDX.Vector2D,ref SharpDX.Vector2D,out SharpDX.Vector2D)"/>.
        /// </summary>
        /// <param name="left">The first vector to multiply.</param>
        /// <param name="right">The second vector to multiply.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="SharpDX.Vector2D"/> to <see cref="SharpDX.Vector3"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="SharpDX.Vector2D"/> to <see cref="SharpDX.Vector4"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator Vector4D(Vector2D value)
        {
            return new Vector4D(value.X, value.Y, 0.0, 0.0);
        }
        ...
        /// <summary>
        /// Determines whether the specified <see cref="SharpDX.Vector2D"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="SharpDX.Vector2D"/> to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="SharpDX.Vector2D"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(ref Vector2D other)
        {
            return FPPrecisionHelper.Equal(other.X, X) && FPPrecisionHelper.Equal(other.Y, Y);
        }
